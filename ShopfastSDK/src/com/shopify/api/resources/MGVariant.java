...
public class MGVariant extends ShopifyResource {
	...
	public int getOldInventoryQuantity() {
		Integer value = (Integer)getAttribute("old_inventory_quantity");
		return value != null ? value : 0;
	}
	@JsonProperty("old_inventory_quantity")
	public void setOldInventoryQuantity(int _old_inventory_quantity) {
		setAttribute("old_inventory_quantity", _old_inventory_quantity);
	}
