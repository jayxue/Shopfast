...
@EndPoint("")
@ContextPath("/admin/custom_collections")  /** Modified by Jay on March 7, 2012. The original context path is "/admin/customCollections", which is incorrect**/
@ResponseHandler(ShopifyResponseHandler.class)
public interface CustomCollectionsService extends BaseShopifyService {

    // GET
    @Path(".json?limit=250")
    List<CustomCollection> getCustomCollections();	// Always get maximal number of collections which is 250
    ...
    @Path("/{0}.json")
    CustomCollectionWithProductsCount getCustomCollectionWithProductsCount(int id);
